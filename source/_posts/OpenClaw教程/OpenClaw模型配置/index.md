...
![步骤1：选择 DeepSeek 模型](./01_select_model.png)
...
![步骤2：进入 DeepSeek 平台并点击 API keys](./02_usage_page_click_api_keys.png)
...
![步骤3：创建 API key](./03_create_api_key.png)
...
![步骤4：复制 API key](./04_copy_api_key.png)
...
![步骤5：粘贴 Key 并保存配置](./05_paste_and_save.png)
